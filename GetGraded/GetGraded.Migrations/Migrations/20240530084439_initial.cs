        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentDetail_AspNetUsers_AspNetUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniversityYearId = table.Column<int>(type: "int", nullable: false),
                    MinunumPassingScore = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Answer_AspNetUsers_ReviewerId",
                        column: x => x.ReviewerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Answer_AspNetUsers_SubmitterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Answer_ReviewerId",
                table: "Answer",
                column: "ReviewerId");

            migrationBuilder.CreateIndex(
                name: "IX_Answer_SubmitterId",
                table: "Answer",
                column: "SubmitterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentDetail_AspNetUserId",
                table: "StudentDetail",
                column: "AspNetUserId");
